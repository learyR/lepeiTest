...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property AvatarUri = new Property(3, String.class, "AvatarUri", false, "AVATAR_URI");
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // AvatarUri
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setAvatarUri(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
